...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmergencySchedule.appointment'
        db.delete_column(u'accounts_emergencyschedule', 'appointment_id')


    def backwards(self, orm):
        # Adding field 'EmergencySchedule.appointment'
        db.add_column(u'accounts_emergencyschedule', 'appointment',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Appointment'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 18, 0, 0)'}),
