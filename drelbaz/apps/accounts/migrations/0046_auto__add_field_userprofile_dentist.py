...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.dentist'
        db.add_column(u'accounts_userprofile', 'dentist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.dentist'
        db.delete_column(u'accounts_userprofile', 'dentist_id')
