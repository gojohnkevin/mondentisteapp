...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DentistDetail.email'
        db.add_column(u'accounts_dentistdetail', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DentistDetail.email'
        db.delete_column(u'accounts_dentistdetail', 'email')
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 7, 0, 0)'}),
