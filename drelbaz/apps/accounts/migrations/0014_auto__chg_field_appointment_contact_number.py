...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appointment.contact_number'
        db.alter_column(u'accounts_appointment', 'contact_number', self.gf('django.db.models.fields.CharField')(default='', max_length=25))

    def backwards(self, orm):

        # Changing field 'Appointment.contact_number'
        db.alter_column(u'accounts_appointment', 'contact_number', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
