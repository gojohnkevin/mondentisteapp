...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appointment.dentist'
        db.add_column(u'accounts_appointment', 'dentist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appointment.dentist'
        db.delete_column(u'accounts_appointment', 'dentist_id')


    models = {
        u'accounts.appointment': {
            'Meta': {'object_name': 'Appointment'},
            'contact_number': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
