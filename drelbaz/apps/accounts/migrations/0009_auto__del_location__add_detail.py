...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'accounts_location')

        # Adding model 'Detail'
        db.create_table(u'accounts_detail', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 19, 0, 0))),
        ))
        db.send_create_signal(u'accounts', ['Detail'])


    def backwards(self, orm):
        # Adding model 'Location'
        db.create_table(u'accounts_location', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 18, 0, 0))),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'accounts', ['Location'])

        # Deleting model 'Detail'
        db.delete_table(u'accounts_detail')
    ...
    models = {
        u'accounts.detail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)'}),
