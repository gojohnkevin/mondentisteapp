...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appointment.emergency'
        db.add_column(u'accounts_appointment', 'emergency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.EmergencySchedule'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appointment.emergency'
        db.delete_column(u'accounts_appointment', 'emergency_id')
    ...
    models = {
        u'accounts.appointment': {
            ...
            'emergency': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.EmergencySchedule']", 'null': 'True', 'blank': 'True'}),
