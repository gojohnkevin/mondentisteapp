...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DentistDetail.pub_date'
        db.alter_column(u'accounts_dentistdetail', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 17, 0, 0)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DentistDetail.pub_date'
        db.alter_column(u'accounts_dentistdetail', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'device_token': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.DeviceToken']", 'symmetrical': 'False'}),
