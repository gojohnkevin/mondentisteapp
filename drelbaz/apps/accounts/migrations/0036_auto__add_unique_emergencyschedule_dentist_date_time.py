...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.emergencyschedule': {
            'Meta': {'ordering': "('-created',)", 'unique_together': "(('dentist', 'date', 'time'),)", 'object_name': 'EmergencySchedule'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'dentist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 25, 0, 0)'}),
