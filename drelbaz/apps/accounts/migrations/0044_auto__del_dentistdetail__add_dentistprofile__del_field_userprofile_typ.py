...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DentistDetail'
        db.delete_table(u'accounts_dentistdetail')

        # Removing M2M table for field device_token on 'DentistDetail'
        db.delete_table(db.shorten_name(u'accounts_dentistdetail_device_token'))
        ...
        db.delete_column(u'accounts_userprofile', 'type')


    def backwards(self, orm):
        # Adding model 'DentistDetail'
        db.create_table(u'accounts_dentistdetail', (
            ('map', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('twitter', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('contact_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('dentist', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ...
        db.send_create_signal(u'accounts', ['DentistDetail'])

        # Adding M2M table for field device_token on 'DentistDetail'
        m2m_table_name = db.shorten_name(u'accounts_dentistdetail_device_token')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dentistdetail', models.ForeignKey(orm[u'accounts.dentistdetail'], null=False)),
            ('devicetoken', models.ForeignKey(orm[u'accounts.devicetoken'], null=False))
        ))
        db.create_unique(m2m_table_name, ['dentistdetail_id', 'devicetoken_id'])
        ...
        db.add_column(u'accounts_userprofile', 'type',
                      self.gf('django.db.models.fields.CharField')(default='patient', max_length=10),
                      keep_default=False)
    ...
    models = {
        ...
        u'accounts.devicetoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'max_length': '150', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
