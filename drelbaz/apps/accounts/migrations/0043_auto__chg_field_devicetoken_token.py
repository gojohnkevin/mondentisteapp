...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeviceToken.token'
        db.alter_column(u'accounts_devicetoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=150, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'DeviceToken.token'
        db.alter_column(u'accounts_devicetoken', 'token', self.gf('django.db.models.fields.CharField')(default='', max_length=150, unique=True))
