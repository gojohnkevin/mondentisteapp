...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_photo', 'caption',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'accounts_photo', 'caption')
    ...
    models = {
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 12, 0, 0)'}),
