...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_book', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Book.title'
        db.alter_column(u'accounts_book', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
