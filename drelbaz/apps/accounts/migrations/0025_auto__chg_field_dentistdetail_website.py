...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DentistDetail.website'
        db.alter_column(u'accounts_dentistdetail', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

    def backwards(self, orm):

        # Changing field 'DentistDetail.website'
        db.alter_column(u'accounts_dentistdetail', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)'}),
