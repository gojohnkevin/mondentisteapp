...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DentistDetail.about'
        db.add_column(u'accounts_dentistdetail', 'about',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DentistDetail.about'
        db.delete_column(u'accounts_dentistdetail', 'about')
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)'}),
