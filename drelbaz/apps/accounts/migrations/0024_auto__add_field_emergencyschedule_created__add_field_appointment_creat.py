...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmergencySchedule.created'
        db.add_column(u'accounts_emergencyschedule', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Appointment.created'
        db.add_column(u'accounts_appointment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmergencySchedule.created'
        db.delete_column(u'accounts_emergencyschedule', 'created')

        # Deleting field 'Appointment.created'
        db.delete_column(u'accounts_appointment', 'created')
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.emergencyschedule': {
            'Meta': {'object_name': 'EmergencySchedule'},
            'appointment': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['accounts.Appointment']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dentist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 13, 0, 0)'}),
