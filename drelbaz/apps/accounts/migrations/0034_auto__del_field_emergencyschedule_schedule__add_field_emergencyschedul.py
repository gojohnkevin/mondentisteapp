...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmergencySchedule.schedule'
        db.delete_column(u'accounts_emergencyschedule', 'schedule')

        # Adding field 'EmergencySchedule.date'
        db.add_column(u'accounts_emergencyschedule', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 9, 5, 0, 0)),
                      keep_default=False)

        # Adding field 'EmergencySchedule.time'
        db.add_column(u'accounts_emergencyschedule', 'time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 9, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EmergencySchedule.schedule'
        db.add_column(u'accounts_emergencyschedule', 'schedule',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EmergencySchedule.date'
        db.delete_column(u'accounts_emergencyschedule', 'date')

        # Deleting field 'EmergencySchedule.time'
        db.delete_column(u'accounts_emergencyschedule', 'time')
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 5, 0, 0)'}),
