...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DeviceToken', fields ['token']
        db.create_unique(u'accounts_devicetoken', ['token'])


    def backwards(self, orm):
        # Removing unique constraint on 'DeviceToken', fields ['token']
        db.delete_unique(u'accounts_devicetoken', ['token'])
    ...
    models = {
        ...
        u'accounts.dentistdetail': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.photo': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)'}),
