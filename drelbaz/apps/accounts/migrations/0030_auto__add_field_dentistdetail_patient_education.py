...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DentistDetail.patient_education'
        db.add_column(u'accounts_dentistdetail', 'patient_education',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DentistDetail.patient_education'
        db.delete_column(u'accounts_dentistdetail', 'patient_education')
