...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appointment.status'
        db.add_column(u'accounts_appointment', 'status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Appointment.status'
        db.delete_column(u'accounts_appointment', 'status')
